...
public class ImageAdapter extends BaseAdapter {
    ...
    private Integer[] mThumbIds = { R.drawable.mercedes_benz_amg_gt, R.drawable.mazda_mx5_2015,
            R.drawable.porsche_911_gts, R.drawable.bmw_serie6_cabrio_2015, R.drawable.ford_mondeo,
            R.drawable.volvo_v60_crosscountry, R.drawable.jaguar_xe, R.drawable.volkswagen_golf_r_variant_2015,
